using MoviesApp.Application.Common.Models;
using MoviesApp.Application.TodoItems.Commands.CreateTodoItem;
using MoviesApp.Application.TodoItems.Commands.DeleteTodoItem;
using MoviesApp.Application.TodoItems.Commands.UpdateTodoItem;
using MoviesApp.Application.TodoItems.Commands.UpdateTodoItemDetail;
using MoviesApp.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace MoviesApp.Web.Endpoints;
